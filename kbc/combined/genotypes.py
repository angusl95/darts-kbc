...
Vis = Genotype(normal=[('sigmoid', 1), ('none', 0), ('sigmoid', 2), ('relu', 1), ('relu', 1), ('none', 0), ('tanh', 1), ('none', 0), ('sigmoid', 2), ('sigmoid', 1)], normal_concat=range(3, 7), reduce=[('identity', 1), ('none', 0), ('sigmoid', 1), ('relu', 2), ('identity', 1), ('relu', 0), ('tanh', 3), ('tanh', 1), ('sigmoid', 4), ('identity', 5)], reduce_concat=range(3, 7))
