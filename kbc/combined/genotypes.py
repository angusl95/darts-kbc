...
WNNet_V1 = Genotype(normal=[('identity', 1), ('tanh', 0), ('identity', 1), ('identity', 2), ('identity', 1), ('relu', 3), ('relu', 2), ('tanh', 1), ('relu', 1), ('identity', 4)], normal_concat=range(3, 7), reduce=[('relu', 1), ('identity', 0), ('tanh', 1), ('identity', 0), ('identity', 0), ('identity', 2), ('tanh', 2), ('identity', 3), ('tanh', 1), ('relu', 4)], reduce_concat=range(3, 7))
FBNet_V1 = Genotype(normal=[('identity', 1), ('relu', 0), ('identity', 1), ('identity', 2), ('identity', 1), ('identity', 2), ('identity', 1), ('identity', 2), ('identity', 3), ('identity', 2)], normal_concat=range(3, 7), reduce=[('identity', 1), ('relu', 0), ('tanh', 2), ('tanh', 0), ('tanh', 3), ('tanh', 0), ('relu', 4), ('relu', 0), ('identity', 2), ('identity', 3)], reduce_concat=range(3, 7))

Vis = Genotype(normal=[('tanh', 1), ('tanh', 0), ('identity', 2), ('tanh', 1), ('identity', 2), ('tanh', 1), ('identity', 2), ('tanh', 1), ('identity', 2), ('tanh', 1)], normal_concat=range(3, 7), reduce=[('identity', 0), ('identity', 1), ('tanh', 1), ('sigmoid', 2), ('tanh', 1), ('identity', 3), ('identity', 2), ('sigmoid', 3), ('identity', 3), ('identity', 0)], reduce_concat=range(3, 7))