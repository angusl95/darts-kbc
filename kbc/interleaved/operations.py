...
OPS = {
  ...
  'conv_1x5'     : lambda C, stride, emb_dim, affine, dropout=0: Conv(C, C, (1,5), (stride,stride), (0,2), affine=affine, dropout=dropout),
  'conv_5x1'     : lambda C, stride, emb_dim, affine, dropout=0: Conv(C, C, (5,1), (stride,stride), (2,0), affine=affine, dropout=dropout),
